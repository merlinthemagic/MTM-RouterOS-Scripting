:local cPath "MTM/Tools/Json/Decode.rsc";
:local s [:toarray ""];
:set ($s->"get") do={

	:global MtmToolJson1;
	:local cPath "MTM/Tools/Json/Decode.rsc/get";
	:local self ($MtmToolJson1->"decode");
	:if ([:typeof $0] = "str") do={
		:return ([($self->"getFromString") $0]);
	}
